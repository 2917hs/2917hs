...
---
🛠️ **Tech Stack** : .NET (C#, ASP.NET Core, MVC, MVVM, WPF, REST, Python, Fast API, SQL, No-SQL) | Cloud (Azure, AWS) | Microservices | Event-Driven system

---
🌐 **GitHub Organization** : [https://github.com](https://github.com/2917hs-org)

---
<img width="16" height="16" alt="favicon-16" src="https://github.com/user-attachments/assets/9dbb057c-b890-4562-bcb9-9668d28bedf6" />**Currently working on** : [Theme Studio](https://2917hs-org.github.io/theme-studio/)
...
---
🔭 **Currently** : Working on cloud-native .NET applications and learning about advanced distributed systems

---
👯 **Open to** : Collaborating on open-source projects, and discussing .NET, Cloud, and Distributed Systems
